...
INSERT INTO
  SpotifyClone.plan(plan_type, price)
VALUES
  ('gratuito', 0.00),
  ('familiar', 7.99),
  ('universitario', 5.99),
...
INSERT INTO
  SpotifyClone.user(user_name, age, plan_id, date_signature)
VALUES
...
INSERT INTO
  SpotifyClone.album(album_name, artist_id, released_date)
VALUES
  ('Envious', 1, 1990),
  ('Exuberant', 1, 1993),
...
INSERT INTO
  SpotifyClone.music(title, duration, album_id)
VALUES
  ("Soul For Us", 200, 1),
...
INSERT INTO
  SpotifyClone.history(user_id, music_id, date_played)
VALUES
